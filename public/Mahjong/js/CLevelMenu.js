function CLevelMenu(){
	...
	_pStartPosExit = {x:CANVAS_WIDTH - (oSprite.width/2) - 10,y:(oSprite.height/2) + 10};
        ...
        _pStartPosSelect = {x:CANVAS_WIDTH/2,y:_aContainerPage[0].y - _aContainerPage[0].getBounds().height/2 -80};
        _oTextLevelOutline = new createjs.Text(TEXT_SELECT_LEVEL ,"40px "+FONT_GAME, "#000");
        _oTextLevelOutline.x = _pStartPosSelect.x;
        _oTextLevelOutline.y = _pStartPosSelect.y;
        _oTextLevelOutline.textAlign = "center";
        _oTextLevelOutline.outline = 2;
        _oContainer.addChild(_oTextLevelOutline);
        
        _oTextLevel = new createjs.Text(TEXT_SELECT_LEVEL ,"40px "+FONT_GAME, "#d7d5d2");
    ...
    this.refreshButtonPos = function(iNewX,iNewY){
        _oTextLevelOutline.y = _pStartPosSelect.y + iNewY;
