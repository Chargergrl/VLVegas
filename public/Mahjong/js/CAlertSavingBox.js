function CAlertSavingBox(szText,oParentContainer){
    ...
    this._init = function (szText) {
        ...
        var oMsgBack = new createjs.Text(szText, "28px " + FONT_GAME, "#000");
        oMsgBack.x = CANVAS_WIDTH / 2;
        oMsgBack.y = 220;
        oMsgBack.textAlign = "center";
        oMsgBack.textBaseline = "middle";
        oMsgBack.lineWidth = 400;
        oMsgBack.outline = 2;
        _oContainer.addChild(oMsgBack);
        
        _oMsg = new createjs.Text(szText, "28px " + FONT_GAME, "#d7d5d2");
